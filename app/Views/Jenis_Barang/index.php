    ...
    <div class="section-body section-emp-summary">
        <div class="row">
            ...
            <div class="col-12">
                <br>
                <div>
              <h6 class="m-0 font-weight-bold text-black">Daftar Jenis Barang</h6>
                </div>
                <br>
              ...
              <div class="row mb-2">
                        <div class="col-4">
                            <div class="input-group">
                                <input type="text" id="searchbox" class="form-control" placeholder="Cari Jenis Barang">
                            ...
                            <div class="btn-group group-action-area ">
                                <a href="<?= base_url('/jenisbarang/create')?>"class="btn btn-danger btn-sm"><i class="fas fa-fw fas fa-plus-circle"></i> Tambah Jenis Barang</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped dataTable" width="100%" cellspacing="0" id="dataTable">
                                ...
                                <tbody>
                                        <?php $total = 0;foreach ($jenis_barang as $u) : ?>
                                            <tr>
                                           <td><?= $u['nama_jenis_barang']; ?></td>
                                            <td><div class="btn-group">
                                                         <a href="<?= base_url('jenisbarang/edit/'.$u['id_jenis_barang'])?>" class="btn btn-outline-light " 
                                                         title="Edit Data" style="color:#4169E1;"><i class="fas fa-pen"></i></a>
                                                
                                                         <button class=" btn btn-outline-light"onclick="deleted(<?= $u['id_jenis_barang']?>,'<?= $u['nama_jenis_barang']?>')" title="Hapus Data"
